    ...
    action: {
      ...
      properties: {
        /* ONDE, no quarto, ela vai fazer isso. String simples de proposito: o
           schema ja esta no limite de campos com union, e `place` nao precisa
           de union nenhuma — vazio significa "onde a acao costuma acontecer". */
        place: {
          type: "string",
          description:
        ...
        type: {
          ...
          enum: [
            "rest",
            // Viver o quarto: ir a um lugar e existir ali, sem produzir nada.
            // Reusa `place` (onde) e `remark` (o que esta fazendo).
            "unwind",
            // A obra do dia. Reusa `text` (o que ela vai desenhar) e `reason`
            // (por que hoje). Uma por dia.
            "draw",
            "search",
            "research",
            "browse",
