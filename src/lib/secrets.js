...
export const SECRET_KEYS = [
  ...
  "ROOK_SOL_KEYPAIR",
  // Elenco novo (CAST) traz chave nova: sem estar nesta lista, o varredor que
  // aborta o turno quando um segredo aparece no prompt nao a reconheceria.
  "YUNA_SOL_KEYPAIR",
  "YUNA_X_API_KEY", "YUNA_X_API_SECRET", "YUNA_X_ACCESS_TOKEN", "YUNA_X_ACCESS_SECRET",
